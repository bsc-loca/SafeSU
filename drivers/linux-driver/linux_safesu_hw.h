#ifndef _LINUX_SAFESU_HW_H_
#define _LINUX_SAFESU_HW_H_
...
#define SAFESU_ADDR 0

#include "linux_safesu_vars.h"
#include "./linux-kernel-module/lkm_safesu.h"
...
// ** Read SAFESU counters and print in a formated way
...
#define EV_SAFESU_ICMISS0(EVENT_4) // Core 0. Instruction cache miss
#define EV_SAFESU_BPMISS0(EVENT_5) // Core 0. Branch Predictor miss
#define EV_SAFESU_DCMISS0(EVENT_6) // Core 0. Data cache L1 miss
#define EV_SAFESU_DCHIT0(EVENT_7) // Core 0. Data cache L1 hit
#define EV_SAFESU_DCMISS1(EVENT_8) // Core 1. Data cache L1 miss
#define EV_SAFESU_DCMISS2(EVENT_9) // Core 2. Data cache L1 miss
#define EV_SAFESU_DCMISS3(EVENT_10) // Core 3. Data cache L1 miss
...
#define SAFESU_DEFAULT_EVENT_COUNT (25u)
static
