...
#define BASE_RDC_WEIGTHS 40
#define N_RDC_WEIGTHS 0
#define END_RDC_WEIGTHS 42
...
#define SAFESU_QUOTA_REM2 (_SAFESU_MCCU_QUOTA[8]) // Quota current remaining for core 2
#define SAFESU_QUOTA_REM3 (_SAFESU_MCCU_QUOTA[9]) // Quota current remaining for core 3
