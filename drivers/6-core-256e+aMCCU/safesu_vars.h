...
#define MCCU_N_CORES 9
#define MCCU_N_EVENTS 2
#define BASE_MCCU_CFG 27
#define N_MCCU_CFG 1
#define END_MCCU_CFG 27
#define BASE_MCCU_LIMITS 28
#define N_MCCU_LIMITS 9
#define END_MCCU_LIMITS 36
#define BASE_MCCU_QUOTA 37
#define N_MCCU_QUOTA 9
#define END_MCCU_QUOTA 45
#define BASE_MCCU_WEIGTHS 46
#define N_MCCU_WEIGTHS 5
#define END_MCCU_WEIGTHS 50
#define N_MCCU_REGS 24
#define RDC_WEIGTHS_WIDTH 8
#define RDC_N_CORES 6
#define RDC_N_EVENTS 2
#define BASE_RDC_VECT 51
#define N_RDC_VECT_REGS 1
#define END_RDC_VECT 51
#define BASE_RDC_WEIGTHS 48
#define N_RDC_WEIGTHS 0
#define END_RDC_WEIGTHS 50
#define BASE_RDC_WATERMARK 52
#define N_RDC_WATERMARK 3
#define END_RDC_WATERMARK 54
#define N_RDC_REGS 4
#define CROSSBAR_INPUTS 256
#define BASE_CROSSBAR 55
#define N_CROSSBAR_CFG 6
#define END_CROSSBAR 58
#define N_CROSSBAR_REGS 6
#define TOTAL_NREGS 61
...
#define SAFESU_QUOTA_SET6 (_SAFESU_MCCU_QUOTA[6]) // Quota set register
#define SAFESU_QUOTA_SET7 (_SAFESU_MCCU_QUOTA[7]) // Quota set register
#define SAFESU_QUOTA_SET8 (_SAFESU_MCCU_QUOTA[8]) // Quota set register

#define SAFESU_QUOTA_REM0 (_SAFESU_MCCU_QUOTA[9]) // Quota current remaining for core 0
#define SAFESU_QUOTA_REM1 (_SAFESU_MCCU_QUOTA[10]) // Quota current remaining for core 1
#define SAFESU_QUOTA_REM2 (_SAFESU_MCCU_QUOTA[11]) // Quota current remaining for core 2
#define SAFESU_QUOTA_REM3 (_SAFESU_MCCU_QUOTA[12]) // Quota current remaining for core 3
#define SAFESU_QUOTA_REM4 (_SAFESU_MCCU_QUOTA[13]) // Quota current remaining for core 4
#define SAFESU_QUOTA_REM5 (_SAFESU_MCCU_QUOTA[14]) // Quota current remaining for core 5
#define SAFESU_QUOTA_REM6 (_SAFESU_MCCU_QUOTA[15]) // Quota current remaining for PQC RD+WR
#define SAFESU_QUOTA_REM7 (_SAFESU_MCCU_QUOTA[16]) // Quota current remaining for PQC RD
#define SAFESU_QUOTA_REM8 (_SAFESU_MCCU_QUOTA[17]) // Quota current remaining for PQC WR

#define EVENT_WEIGTH_REG0 (_SAFESU_MCCU_QUOTA[18]) // Event weight register 0 (input 0 to 3)
#define EVENT_WEIGTH_REG1 (_SAFESU_MCCU_QUOTA[19]) // Event weight register 1 (input 4 to 7)
#define EVENT_WEIGTH_REG2 (_SAFESU_MCCU_QUOTA[20]) // Event weight register 2 (input 8 to 11)
#define EVENT_WEIGTH_REG3 (_SAFESU_MCCU_QUOTA[21]) // Event weight register 3 (input 12 to 15)
#define EVENT_WEIGTH_REG4 (_SAFESU_MCCU_QUOTA[22]) // Event weight register 4 (input 16 to 19)
