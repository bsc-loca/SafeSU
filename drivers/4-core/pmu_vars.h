...
#define END_MCCU_QUOTA 35
#define BASE_MCCU_WEIGHTS 36
#define N_MCCU_WEIGHTS 2
#define END_MCCU_WEIGHTS 37
...
#define BASE_RDC_WATERMARK 39
#define N_RDC_WATERMARK 2
#define END_RDC_WATERMARK 40
#define N_RDC_REGS 3
#define CROSSBAR_INPUTS 128
#define BASE_CROSSBAR 41
#define N_CROSSBAR_CFG 6
#define END_CROSSBAR 44
