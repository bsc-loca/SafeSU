...
\begin{itemize}
	...
	\item \textbf{Alternative MCCU }(Alternative Maximum Contention Control Unit) : Contention control tailoring the PQC accelerator. Unique interruption capable after any threshold of contention is exceeded. It requires specific weight and crossbar configuration so signals match required value and index.
