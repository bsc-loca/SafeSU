...
%%Not tested in the 4-core setup
%\begin{table}[H]
...
%Quota exhaustion for cores 3, 2, 1, and 0 is mapped to AHB interrupts 10, 9, 8, and 7, respectively.\\
\\
...
\begin{register}{H}{MCCU event weights register 1 (shared with RDC)}{0x09c}
	...
	\reglabel{Reset value}\regnewline
\end{register}
\begin{register}{H}{MCCU event weights register 2 (shared with RDC)}{0x0a0}
	\label{MCCU_weight1}
...
\begin{register}{H}{RDC interrupt vector}{0x0a4}
	\label{RDC_intrv}
...
\begin{register}{H}{RDC event weights register 1 (shared with MCCU)}{0x09c}
	...
	\reglabel{Reset value}\regnewline
\end{register}
\begin{register}{H}{RDC event weights register 2 (shared with MCCU)}{0x0a0}
	\label{MCCU_weight1}
	\regfield{Input 11}{8}{24}{{00}}
	\regfield{Input 10}{8}{16}{{00}}
	\regfield{Input 9}{8}{8}{{00}}
...
\begin{register}{H}{RDC watermark register 0}{0x0a8}
	\label{RDC_water0}
	\regfield{Input 3}{8}{24}{{00}}
	\regfield{Input 2}{8}{16}{{00}}
	\regfield{Input 1}{8}{8}{{00}}
...
\begin{register}{H}{RDC watermark register 1}{0x0ac}
	\label{RDC_water1}
	\regfield{Input 7}{8}{24}{{00}}
	\regfield{Input 6}{8}{16}{{00}}
	\regfield{Input 5}{8}{8}{{00}}
...
\begin{register}{H}{RDC watermark register 2}{0x0b0}
	\label{RDC_water2}
	\regfield{Input 11}{8}{24}{{00}}
	\regfield{Input 10}{8}{16}{{00}}
	\regfield{Input 9}{8}{8}{{00}}
