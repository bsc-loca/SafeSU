...
source /users/gcabo/genus_runs_pmu/bsc_pmu_nft1000/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.flowkit_settings.tcl

source /users/gcabo/genus_runs_pmu/bsc_pmu_nft1000/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.invs_init.tcl
...
source /users/gcabo/genus_runs_pmu/bsc_pmu_nft1000/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.preserve.tcl



# Mode Setup
################################################################################
source /users/gcabo/genus_runs_pmu/bsc_pmu_nft1000/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.mode

# Source cell padding from Genus
################################################################################
source /users/gcabo/genus_runs_pmu/bsc_pmu_nft1000/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.cell_pad.tcl 
...
if {[is_attribute -obj_type port original_name] && [is_attribute -obj_type pin original_name] && [is_attribute -obj_type pin is_phase_inverted]} {
  source /users/gcabo/genus_runs_pmu/bsc_pmu_nft1000/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.wnm_attrs.tcl
}
