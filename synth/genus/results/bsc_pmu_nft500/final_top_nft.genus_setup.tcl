...
################################################################################
source /users/gcabo/genus_runs_pmu/bsc_pmu_nft500/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.genus_init.tcl
...
phys::read_script /users/gcabo/genus_runs_pmu/bsc_pmu_nft500/synth/genus/genus_build/tsmc_10tracks_reports/final_top_nft.g.gz
...
unset _slk_
# multi-mode slack
if {"[string_representation [::legacy::get_attribute slack_by_mode design:top_nft]]" != "{{mode:top_nft/view_typ 766.9} {mode:top_nft/view_slow 54.5} {mode:top_nft/view_superslow 0.1} {mode:top_nft/view_fast 1078.1}}"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden slack_by_mode: {{mode:top_nft/view_typ 766.9} {mode:top_nft/view_slow 54.5} {mode:top_nft/view_superslow 0.1} {mode:top_nft/view_fast 1078.1}}  current slack_by_mode: [string_representation [::legacy::get_attribute slack_by_mode design:top_nft]]"
}
# tns
...
if {$_cell_area_ != "58934"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden cell area: 58934,  current cell area: $_cell_area_"
}
unset _cell_area_
# net area
...
if {$_net_area_ != "28349"} {
   mesg_send [::legacy::find -message /messages/PHYS/PHYS-92] "golden net area: 28349,  current net area: $_net_area_"
}
unset _net_area_
