...
source /users/gcabo/bsc_pmu/synth/genus/genus_build/tsmc_10tracks_reports/final_top.flowkit_settings.tcl

source /users/gcabo/bsc_pmu/synth/genus/genus_build/tsmc_10tracks_reports/final_top.invs_init.tcl
...
source /users/gcabo/bsc_pmu/synth/genus/genus_build/tsmc_10tracks_reports/final_top.preserve.tcl



# Mode Setup
################################################################################
source /users/gcabo/bsc_pmu/synth/genus/genus_build/tsmc_10tracks_reports/final_top.mode

# Source cell padding from Genus
################################################################################
source /users/gcabo/bsc_pmu/synth/genus/genus_build/tsmc_10tracks_reports/final_top.cell_pad.tcl 
...
if {[is_attribute -obj_type port original_name] && [is_attribute -obj_type pin original_name] && [is_attribute -obj_type pin is_phase_inverted]} {
  source /users/gcabo/bsc_pmu/synth/genus/genus_build/tsmc_10tracks_reports/final_top.wnm_attrs.tcl
}
