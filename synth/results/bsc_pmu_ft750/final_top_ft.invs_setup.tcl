...
source /users/gcabo/genus_runs_pmu/bsc_pmu_ft750/synth/genus/genus_build/tsmc_10tracks_reports/final_top_ft.flowkit_settings.tcl

source /users/gcabo/genus_runs_pmu/bsc_pmu_ft750/synth/genus/genus_build/tsmc_10tracks_reports/final_top_ft.invs_init.tcl
...
source /users/gcabo/genus_runs_pmu/bsc_pmu_ft750/synth/genus/genus_build/tsmc_10tracks_reports/final_top_ft.preserve.tcl



# Mode Setup
################################################################################
source /users/gcabo/genus_runs_pmu/bsc_pmu_ft750/synth/genus/genus_build/tsmc_10tracks_reports/final_top_ft.mode

# Source cell padding from Genus
################################################################################
source /users/gcabo/genus_runs_pmu/bsc_pmu_ft750/synth/genus/genus_build/tsmc_10tracks_reports/final_top_ft.cell_pad.tcl 
...
if {[is_attribute -obj_type port original_name] && [is_attribute -obj_type pin original_name] && [is_attribute -obj_type pin is_phase_inverted]} {
  source /users/gcabo/genus_runs_pmu/bsc_pmu_ft750/synth/genus/genus_build/tsmc_10tracks_reports/final_top_ft.wnm_attrs.tcl
}
