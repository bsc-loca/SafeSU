...
//***task automatic test_sim***
    ...
    //***task automatic test_alt_mccu
    task automatic test_alt_mccu;
        begin
            tb_test_name="test_alt_MCCU";
            // Reset MCCU
            write_reg(0,32'h40000000);
            write_reg(0,32'h40000001);
            write_reg(27,32'h00000002);
            write_reg(27,32'h00000000);
            #CLK_PERIOD;
            // Set weights
            write_reg(46,32'h04030201);
            write_reg(47,32'h08070605);
            write_reg(48,32'h12111009);
            write_reg(49,32'h16151413);
            write_reg(50,32'h20191817);
            // Set quotas
            for(j=0;j<TB_MCCU_N_CORES+TB_MCCU_ALT_N_CORES;j++) begin
              write_reg(28+j,32'h00000500);
            end
            write_reg(27,32'h000007FC);
            // Enable MCCU
            write_reg(27,32'h00000001);
