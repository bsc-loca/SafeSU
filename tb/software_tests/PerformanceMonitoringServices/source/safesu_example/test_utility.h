...
//Multicore test 6-core configuration
   {CROSSBAR_OUTPUT_1,    EVENT_0,    "\033[0;34m Constant High (Clock cycles) \033[0m"},
    ...
    {CROSSBAR_OUTPUT_3,    EVENT_45,   "\033[0;33m Contention caused to core 0 due to core 2 AHB accesses \033[0m"},
    {CROSSBAR_OUTPUT_4,    EVENT_46,   "\033[0;33m Contention caused to core 0 due to core 3 AHB accesses \033[0m"},
    {CROSSBAR_OUTPUT_5,    EVENT_47,   "\033[0;33m Contention caused to core 0 due to core 4 AHB accesses \033[0m"},
    {CROSSBAR_OUTPUT_6,    EVENT_48,   "\033[0;33m Contention caused to core 0 due to core 5 AHB accesses \033[0m"},
    {CROSSBAR_OUTPUT_7,    EVENT_6,   "\033[0;33m Data Cache L1 miss Core 0 \033[0m"},
    {CROSSBAR_OUTPUT_8,    EVENT_13,   "\033[0;33m Data Cache L1 miss Core 1 \033[0m"},
    {CROSSBAR_OUTPUT_9,    EVENT_2,   "\033[0;33m Instruction count pipeline 0, Core 0 \033[0m"},
    {CROSSBAR_OUTPUT_10,    EVENT_3,   "\033[0;33m Instruction count pipeline 1, Core 0 \033[0m"},
